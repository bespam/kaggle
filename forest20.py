...
def train():
    ...
    joined_data = np.delete(joined_data,[0,2,7,9],1) #remove the id, name, cabin,ticket, embark
    ...
    clf_m = GridSearchCV(forest_m, tuned_parameters, cv=30)
    ...
    clf_f = GridSearchCV(forest_f, tuned_parameters, cv=30)
    ...
    open_file_object = csv.writer(open("csv/forest20.csv", "wb"))
